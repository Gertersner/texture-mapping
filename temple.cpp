...
void init()
{
    ...
    cs4722::init_texture_from_file("../media/grass.jpg", 1);
    auto wrap_type = GL_MIRRORED_REPEAT;
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, wrap_type);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, wrap_type);
    cs4722::init_texture_from_file("../media/wood.jpg", 0);
    cs4722::init_texture_from_file("../media/stones.jpg", 2);
    cs4722::init_texture_from_file("../media/tiles.jpg", 3);
    cs4722::init_texture_from_file("../media/bricks.jpg", 4);
...
//            artf->rotation_rate = M_PI / 3;
            ...
            auto red = x * ca / (number - 1) + cb;
            auto green = y * ca / (number - 1) + cb;
            auto blue = (x + y) * ca / (2 * number - 2) + cb;
            auto color = cs4722::color::color_rgb(red, green, blue);
            artf-> surface_effect = (2 * x + 3 * y + 4) % 5;
            artf-> texture_unit = (y % 3) + 2;
            artf->surface_material.diffuse_color = color;
...
main(int argc, char** argv)
{
    ...
    GLFWwindow *window = cs4722::setup_window_9_16_9("Temple");
